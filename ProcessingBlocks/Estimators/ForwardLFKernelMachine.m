classdef ForwardLFKernelMachine
    ...
    methods
        function [v_estimate, meanErrOnEvalFeat] = ...
                evaluate(obj, m_queryFeatures)
            
            [v_estimate, meanErrOnEvalFeat] = obj.estimator.estimateGivenEstimatedDistances(... % sugg: change method name to: evaluateEstimatedMap[given features]
